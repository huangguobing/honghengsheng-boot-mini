-- ============================================================
-- 鸿恒盛 ERP 全量数据库 SQL (完整版)
-- 生成日期: 2026-03-06
-- 说明: 包含全部 ERP 业务表(15张) + 系统基础表(system_*/infra_*)
--       已合并所有增量变更，可直接用于全新建库
-- ============================================================
...
-- 统计报表 (5150-5158)
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES
(5150, '统计报表', '', 1, 60, 0, '/statistics', 'ep:data-analysis', '', '', 0, b'1', b'1', b'1', 'admin', NOW(), 'admin', NOW(), b'0'),
(5151, '客户销售统计', 'erp:statistics:customer-sales', 2, 1, 5150, 'customerSales', '', 'erp/statistics/customerSales/index', 'CustomerSales', 0, b'1', b'1', b'1', 'admin', NOW(), 'admin', NOW(), b'0'),
(5152, '项目利润统计', 'erp:statistics:project-profit', 2, 2, 5150, 'projectProfit', '', 'erp/statistics/projectProfit/index', 'ProjectProfit', 0, b'1', b'1', b'1', 'admin', NOW(), 'admin', NOW(), b'0'),
(5153, '产品销量统计', 'erp:statistics:product-sales', 2, 3, 5150, 'productSales', '', 'erp/statistics/productSales/index', 'ProductSales', 0, b'1', b'1', b'1', 'admin', NOW(), 'admin', NOW(), b'0'),
(5154, '应收应付统计', 'erp:statistics:receivable-payable', 2, 4, 5150, 'receivablePayable', '', 'erp/statistics/receivablePayable/index', 'ReceivablePayable', 0, b'1', b'1', b'1', 'admin', NOW(), 'admin', NOW(), b'0'),
(5155, '发票汇总', 'erp:statistics:invoice-summary', 2, 5, 5150, 'invoiceSummary', '', 'erp/statistics/invoiceSummary/index', 'InvoiceSummary', 0, b'1', b'1', b'1', 'admin', NOW(), 'admin', NOW(), b'0');
...
CROSS JOIN (
  ...
  UNION SELECT 5150 UNION SELECT 5151 UNION SELECT 5152 UNION SELECT 5153 UNION SELECT 5154 UNION SELECT 5155
) m
